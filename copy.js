  ...
  fetch("http://localhost:1111/products")
    ...
    .then((data) => {
      ...
      products.forEach((product, index) => {
        ...
        <div class="container-sm adenn" onclick="pickeditem(${index})">
...
function cum() {
  ...
  for (i = 0; i < newarry.length; i++) {
    ...
    phonesection.innerHTML += `<div class="container-sm adenn1" onclick="pickeditem(${i})">
    <div class="container-sm display:flex;">
...
function frank() {
  ...
  for (i = 0; i < bird.length; i++) {
    ...
    fragrances.innerHTML += `<div class="container-sm adenn1" onclick="pickeditem(${i})">
    <div class="container-sm display:flex;">
...
function comp() {
  ...
  for (i = 0; i < best.length; i++) {
    ...
    put.innerHTML += `<div class="container-sm adenn1" onclick="pickeditem(${i})">
    <div class="container-sm display:flex;">
...
function pickeditem(index) {
  try {
    ...
    console.error("Error in pickedItem function:", error);
  }
}
function rrr() {
